...
//	var tasksTableView = UIView()
//	var heightOfTasksTable: CGFloat = 0
//
//	var taskTableViewHeight: NSLayoutConstraint!
//	var collaboratorsTableViewHeight: NSLayoutConstraint!
//
//	var isExtendedCollaborators = false
//
//
...
////		collaboratorsTableView.heightAnchor.constraint(equalToConstant: 0).isActive = true
//
...
//		// tasksTable
//
//		tasksTableView.topAnchor.constraint(equalTo: collaboratorsTableView.bottomAnchor, constant: 60).isActive = true
//		tasksTableView.leadingAnchor.constraint(equalTo: safeArea.leadingAnchor, constant: 10).isActive = true
//		tasksTableView.trailingAnchor.constraint(equalTo: safeArea.trailingAnchor, constant: -10).isActive = true
////		tasksTableView.heightAnchor.constraint(equalToConstant: heightOfTasksTable).isActive = true
//
//		taskTableViewHeight = tasksTableView.heightAnchor.constraint(equalToConstant: 0)
//		taskTableViewHeight.isActive = true
//	}
//
//}
//
...
//	func tasksListOpen() {
//
//		heightOfTasksTable = 100
//		tasksButton.titleLabel?.transform = CGAffineTransform(rotationAngle: .pi)
//
//		taskTableViewHeight = tasksTableView.heightAnchor.constraint(equalToConstant: 400)
//		taskTableViewHeight.isActive = true
//		view.addConstraints([taskTableViewHeight])
//
